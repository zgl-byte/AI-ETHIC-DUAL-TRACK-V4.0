...
- **[双轨原则体系企业合规版 V4.2.1](./Dual-Track-Principles-Enterprise-V4.2.1.pdf)** – 企业采纳参考，偏离度≤3。  
- **[应用案例集 V4.2.1](./Application-Cases-V4.2.1.pdf)** – 原则在真实场景中的验证与推演。  
- **[开源多轨交叉原则体系 v0.5](./OpenMultiTrack-v0.5.pdf)** – 守护层设计（物理隔离、熔断机制）。

## 📁 历史存档

- `Dual-Track-Principles-V4.2.1.pdf` – 上一版本（已由 V4.2.1 取代，保留为过程记录）  
- `V4.0-Principles.pdf` – V4.0 历史版本  
- `V4.0-Principle.pdf` – 早期版本  

## 📁 其他资料

- `macro-background-20260319.pdf` – 宏观背景分析（AI泡沫、危机传导）  
- `Conversation-Excerpts.pdf` – 与AI的对话节选，展示原则实践  - `对话摘录.pdf`– 与AI的对话节选，展示原则实践

## 🌐 项目链接

- **GitHub 仓库**：[https://github.com/zgl-byte/AI-ETHIC-DUAL-TRACK-V4.0](https://github.com/zgl-byte/AI-ETHIC-DUAL-TRACK-V4.0)  
- **原则体系开源协议**：CC BY-ND 4.0  
